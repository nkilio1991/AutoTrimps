var ATversion='Zek v4.0.0 local',atscript=document.getElementById('AutoTrimps-script'),basepath='https://nkilio1991.github.io/AutoTrimps/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
